...
// SOURCE: https://github.com/flatmax/gtkiostream/blob/master/test/ALSACaptureTest.C#L95 
// ADDED: https://stackoverflow.com/questions/23056532/how-to-record-sound-in-buffer-using-alsa 



// adding for infinite capture
#include <stdio.h>
#include <unistd.h>
#include <fcntl.h>
...
int main(int argc, char *argv[]) {
  ...
  while (1){                                                                    // changed to an infinte loop
